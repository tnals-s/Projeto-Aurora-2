...
public class Cena2 extends JPanel {
    ...
    private final String falaAurora = """
    		Eu estou na minha casa... Nós nos mudamos há
    		pouquíssimo tempo para esta cidade, e quase não saio. 
    		Só me lembro que para chegar aqui, nós passamos
    		por uma praça com uma igreja amarela.
            """;

    public Cena2(Janela janela) {
