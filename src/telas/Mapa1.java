...
public class Mapa1 extends JPanel {
    ...
    public Mapa1(Janela janela) {
        this.janela = janela;
        fundo = new ImageIcon(getClass().getResource("/imagens/MapaM1.jpeg")).getImage();
        setLayout(null);

        JButton igreja = new JButton();
        igreja.setBounds(1036, 297, 120, 120);
        configurarBotao(igreja);
        igreja.addActionListener(e -> janela.trocarTela("MISSAO1"));
        add(igreja);
        ...
        JOptionPane.showMessageDialog(this, "Missão indisponível."));
        add(restaurante);
